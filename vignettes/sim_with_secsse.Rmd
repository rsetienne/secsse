...
work, we refer to the vignette `starting_secsse`. We will here first simulate
using the CR model:
...
provide actual starting parameters. secsse has a helping function for that as
well!
...
Notice that `secsse::sim_tree` can simulate a tree conditioning on different
