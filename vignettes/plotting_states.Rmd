...
0A, 1A, 0B and 1B. Furthermore, the last four columns indicate the survival rates,
which are equal to 1 - extinction. If we are interested in the posterior probability of trait 0,
...
Using the explicit evaluations is more precise, but might be memory heavy. Usually,
