...
secsse_sim_cpp <- function(m_R, lambdas_R, q_R, max_time, max_species, init_states, conditioning) {
    .Call(`_secsse_secsse_sim_cpp`, m_R, lambdas_R, q_R, max_time, max_species, init_states, conditioning)
}
