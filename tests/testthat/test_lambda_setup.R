...
test_that("setup", {
  ...
  lambda_matrices_CR <- secsse::create_lambda_matrices(state_names = c("S", "N"),
                                                    num_concealed_states = 2, 
  ...
  lambda_matrices_CTD <- secsse::create_lambda_matrices(state_names = c("S", "N"),
                                                    num_concealed_states = 2, 
                                                  transition_list = focal_list,
                                                    model = "CTD")
  ...
  # and the ETD model:
  lambda_matrices_ETD <- secsse::create_lambda_matrices(state_names = c("S", "N"),
                                                    num_concealed_states = 2, 
                                                  transition_list = focal_list,
                                                    model = "ETD")
