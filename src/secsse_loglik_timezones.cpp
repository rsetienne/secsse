...
double calc_ll_timezone_compound(const Rcpp::List& params,
...
// [[Rcpp::export]]
Rcpp::List calThruNodes_timezones_compound_cpp(const NumericVector& ances,
                                      const NumericMatrix& states_R,
                                      const NumericMatrix& forTime_R,
                                      const List& params,
                                      const NumericVector& crit_t,
...
//  std::cerr << "welcome! we are incpp now\n";
  ...
  if (is_complete_tree) {
    ...
    loglik = calc_ll_timezone_compound(params,
                                       crit_t,
                                       std::vector<int>(ances.begin(), ances.end()),
                                       forTime,
                                       states,
