...
// cla_calThruNodes_timezones_compound_cpp
Rcpp::List cla_calThruNodes_timezones_compound_cpp(const Rcpp::NumericVector& ances, const Rcpp::NumericMatrix& states_R, const Rcpp::NumericMatrix& forTime_R, const Rcpp::List& params, const Rcpp::NumericVector& crit_t, std::string method, double atol, double rtol, bool is_complete_tree);
RcppExport SEXP _secsse_cla_calThruNodes_timezones_compound_cpp(SEXP ancesSEXP, SEXP states_RSEXP, SEXP forTime_RSEXP, SEXP paramsSEXP, SEXP crit_tSEXP, SEXP methodSEXP, SEXP atolSEXP, SEXP rtolSEXP, SEXP is_complete_treeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector& >::type ances(ancesSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type rtol(rtolSEXP);
    Rcpp::traits::input_parameter< bool >::type is_complete_tree(is_complete_treeSEXP);
    rcpp_result_gen = Rcpp::wrap(cla_calThruNodes_timezones_compound_cpp(ances, states_R, forTime_R, params, crit_t, method, atol, rtol, is_complete_tree));
    return rcpp_result_gen;
END_RCPP
}
// calThruNodes_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_secsse_cla_calThruNodes_timezones_compound_cpp", (DL_FUNC) &_secsse_cla_calThruNodes_timezones_compound_cpp, 9},
