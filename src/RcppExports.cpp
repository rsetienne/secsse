...
// calc_ll_cpp
Rcpp::List calc_ll_cpp(const std::string& rhs, const Rcpp::IntegerVector& ances, const Rcpp::NumericMatrix& states, const Rcpp::NumericMatrix& forTime, const Rcpp::RObject& lambdas, const Rcpp::NumericVector& mus, const Rcpp::NumericMatrix& Q, const std::string& method, double atol, double rtol, bool is_complete_tree, bool see_states, bool use_log_transform);
RcppExport SEXP _secsse_calc_ll_cpp(SEXP rhsSEXP, SEXP ancesSEXP, SEXP statesSEXP, SEXP forTimeSEXP, SEXP lambdasSEXP, SEXP musSEXP, SEXP QSEXP, SEXP methodSEXP, SEXP atolSEXP, SEXP rtolSEXP, SEXP is_complete_treeSEXP, SEXP see_statesSEXP, SEXP use_log_transformSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string& >::type rhs(rhsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type use_log_transform(use_log_transformSEXP);
    rcpp_result_gen = Rcpp::wrap(calc_ll_cpp(rhs, ances, states, forTime, lambdas, mus, Q, method, atol, rtol, is_complete_tree, see_states, use_log_transform));
    return rcpp_result_gen;
END_RCPP
}
// ct_condition_cpp
...
Rcpp::List calc_ll_single_branch_cpp(const std::string& rhs, const Rcpp::NumericVector& states, const Rcpp::NumericVector& forTime, const Rcpp::RObject& lambdas, const Rcpp::NumericVector& mus, const Rcpp::NumericMatrix& Q, const std::string& method, double atol, double rtol, bool see_states, bool use_log_transform);
RcppExport SEXP _secsse_calc_ll_single_branch_cpp(SEXP rhsSEXP, SEXP statesSEXP, SEXP forTimeSEXP, SEXP lambdasSEXP, SEXP musSEXP, SEXP QSEXP, SEXP methodSEXP, SEXP atolSEXP, SEXP rtolSEXP, SEXP see_statesSEXP, SEXP use_log_transformSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string& >::type rhs(rhsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type see_states(see_statesSEXP);
    Rcpp::traits::input_parameter< bool >::type use_log_transform(use_log_transformSEXP);
    rcpp_result_gen = Rcpp::wrap(calc_ll_single_branch_cpp(rhs, states, forTime, lambdas, mus, Q, method, atol, rtol, see_states, use_log_transform));
    return rcpp_result_gen;
END_RCPP
}
