...
double calc_ll_cla_timezones_compound(const Rcpp::List& params,
...
// [[Rcpp::export]]
Rcpp::List cla_calThruNodes_timezones_compound_cpp(const Rcpp::NumericVector& ances,
                                                   const Rcpp::NumericMatrix& states_R,
                                                   const Rcpp::NumericMatrix& forTime_R,
  ...
  try {
    ...
    if (is_complete_tree) {
      ...
      loglik = calc_ll_cla_timezones_compound(params,
                                              crit_t,
                                              std::vector<int>(ances.begin(), ances.end()),
                                              forTime,
                                              states,
